		...
		<div id="templatemo_wrapper">
			...
			<form action="Login2" method="post">
				...
				<div class="login-card">
					...
					%>
					<p style="color: orangered; font-size: large; font: bold">
						<%=s%>
					</p>
					...
					<br>
						<form>
							<input type="text" name="uid" placeholder="Userid" /> <input
								type="password" name="pwd" placeholder="Password" /> <select
...
<option value="tpa">Third Parity Auditor</option><br>-->
							</select> <br> <input type="submit" name="login"
