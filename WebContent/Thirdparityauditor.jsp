<%-- 
    Document   : Thirdparityauditor
    Created on : Nov 3, 2014, 12:25:59 PM
    Author     : Raja
--%>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content_wrapper">
      ...
      <tr>
          <td width="149"><div align="center" class="style1" > <li class ="selected"><a href="Accessfile.jsp"><strong style="font-size: 17px; ;color: greenyellow">File Access View</strong></a></li></div></td>
          <td width="149"><div align="center" class="style1" > <a href="Blockuser.jsp"><strong style="font-size: 17px; ;color: greenyellow">Block User</strong></a></div></td>
        <td width="166"><div align="center" class="style1"><a href="Userreq.jsp"><strong style="font-size: 17px;color: greenyellow ">Requested Users</strong></a></div></td>
