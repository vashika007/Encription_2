<%-- 
    Document   : User
    Created on : Nov 7, 2014, 3:32:19 PM
    Author     : Raja
--%>
...
<div id="templatemo_wrapper">
   ...
   <%
    ...
    String st=request.getAttribute("status")!=null?request.getAttribute("status").toString():"";
%>
  <h4 align="right" style="margin-top:-20px;margin-right: 36px;"> Name : <font color="red"><%=a%></font></h4>
<h3><font color="green"> <%= s %></font></h3>
<h3><font color="green"> <%= st %></font></h3>
<div align="center"> <img width="800" height="400" src="images1/download1.jpg" alt="" style="border-radius:20px" /></div> 
              </div>
