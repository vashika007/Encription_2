<%-- 
    Document   : unblock
    Created on : Nov 6, 2014, 10:03:02 AM
    Author     : Raja
--%>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content_wrapper">
      ...
      <tr>
          <td width="149"><div align="center" class="style1" > <a href="Accessfile.jsp"></a><strong style="font-size: 17px; ;color: greenyellow">File Access View</strong></a></li></div></td>
        ...
        <%
String s=request.getAttribute("msg3")!=null?request.getAttribute("msg3").toString():"";
%>
     <%=s %>
   
    <div align="center">
        <table class="table1" border="1">
            <tr style="height: 30px; background-color: #99CF45;">
          ...
          <%
            String s1="",s2="",s3="";
                        try {
                           ...
                           String sa = "select * from blockreq";
                            //String sa= "select username, type,ipaddress,decryptkey from domain where  username ='2'and permit='Access';
                            ...
                            while(rs.next())
                           {
                            ...
                            //Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/social", "root", "root");
                            //MODIFICATION 2 (END)...          
                            //PreparedStatement pr=con.prepareStatement("select * from Reg");
                           String sa1 = "select name from register where name='"+s1+"' and password='"+s2+"' and status='block'";
                         //  String sa= "select username, type,ipaddress,decryptkey from domain where  username ='2'and permit='Access';
                            ...
                            while(rs1.next())
                                ...
                                <tr style="height: 30px; background-color: orange;">
                                    <td><input type="text"  style="background-color: orange;" value="<%=s1%>" readonly="" name="reqname"></input></td>
                                    <td><%=s3%></td>
                                    <div class="">
                                            <td><input type="submit" style="background-color: greenyellow" value="Allow"/></td>
                      </div>
                                </tr></form>
            </table>
                                <%
